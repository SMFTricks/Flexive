...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			'id' => 'st_enable_header_background',
			'label' => $txt['st_enable_header_background'],
			'description' => $txt['st_enable_header_background_desc'],
			'type' => 'checkbox',
			'default' => true
		),
		array(
			'id' => 'st_custom_header_url',
			'label' => $txt['st_custom_header_url'],
			'description' => $txt['st_custom_header_url_desc'],
			'type' => 'text'
		),
		array(
		...
		array(
			'id' => 'st_enable_menuicons',
			'label' => $txt['st_enable_menuicons'],
			'type' => 'checkbox',
			'default' => false
		),
	'',
